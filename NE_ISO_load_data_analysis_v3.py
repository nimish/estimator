...
app._unparsable_cell(
    r"""
    mo.md(\"
        \"\"\"In this version, we take the log of the load data before model fitting. This performs slightly better, suggesting the components are multiplicative rather than additive.\"\"\"
    )
    """,
    name="_"
)
